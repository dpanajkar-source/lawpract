...
<div id="page_content">
    <div id="page_content_inner">
        ...
        <h3 class="heading_b uk-margin-bottom">Address Book</h3>
    ...
    <form>
		...
		<div class="uk-width-medium-1-3" style="padding-bottom:10px">
      	<input type="text" class="md-input" name="clientname" id="clientname" placeholder="Type Name and Enter to Search"/></div>
        <div class="uk-width-medium-1-3" style="padding-bottom:0px">
       	<button type="submit" style="visibility:hidden" class='md-btn md-btn-primary' id="LoadRecordsButton"></button>  </div> 
...
<div class="md-fab-wrapper">
  ...
  <?php include("footersrc.php");      ?>
    ...
    <!--  diff functions -->
    <script src="assets/js/CRUD/bf_bankclient.js"></script>
