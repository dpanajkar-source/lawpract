...
<div id="page_content">
    <div id="page_content_inner">
        ...
        <h3 class="heading_b uk-margin-bottom">Chart Details Grid</h3>
    ...
    <form>
		...
		<div class="uk-width-medium-1-3" style="padding-bottom:10px">
      	<input type="text" class="md-input" name="chartdetailssearch" id="chartdetailssearch" placeholder="Type Search word and Enter"/></div>
...
-->
    ...
    <!--  diff functions -->
    <script src="assets/js/CRUD/chartdetails.js"></script>
