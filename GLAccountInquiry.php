...
echo '<table>
        <tr>
         <td>'.'Account'.":</td>
         <td><select Name='Account' class='md-input'>";
	...
	//Select the tag
	echo '<tr><td>' . 'Select Tag' . ':</td><td><select name="tag" class="md-input">';
...
// End select tag
         ...
         <td><select Name=Period[] multiple class="md-input">';
...
<div class='centre'><input type=submit name='Show' VALUE='".'Show Account Transactions'."'></div></form>";
...
if (isset($ShowIntegrityReport) and $ShowIntegrityReport==True){
	...
	prnMsg( 'There are differences between the sum of the transactions and the recorded movements in the ChartDetails table') . '. ' . _('A log of the account differences for the periods report shows below','warn');
