...
<td><a style="color:#ffffff; font-weight:bold; text-transform:capitalize;" class="md-btn md-btn-block md-btn-primary md-btn-wave-light waves-effect waves-button waves-light" href="new_PDFNoticesList.php" target="_blank">Notice List</a></td></tr>
...
if(isset($_POST['Categorywisecases']))
	...
	DB_free_result($result);
		...
		echo '<div class="uk-width-medium-1-4" style="padding-bottom:10px">';
		echo '<input type="Submit" Name="Categorywisereport" class="md-btn md-btn-primary" Value="View categorywise Cases"></div></div></div>';
...
<?php 			echo '<div style="padding-bottom:10px"><input type="submit" name="uk_Daywisereport" class="md-btn md-btn-primary" value="View Report">';
 ...
 //---------------------------------- Search for Courtwise Cases----------------------------------
   ...
   if(isset($_POST['Courtwisecases']))
	...
	DB_free_result($result);
		...
		echo '<div class="uk-width-medium-1-4" style="padding-bottom:10px"><input type="Submit" Name="Courtwisereport" class="md-btn md-btn-primary" Value="View Courtwise Report"></div></div>';
 ...
 //---------------------------------- Search for Stagewise Cases----------------------------------
   ...
   if(isset($_POST['Stagewisecases']))
	...
	DB_free_result($result);
		...
		echo '<div class="uk-width-medium-1-4" style="padding-bottom:10px"><input type="Submit" Name="Stagewisereport" class="md-btn md-btn-primary" Value="View Stagewise Report"></div></div>';
  ...
  //---------------------------------- Statuswise Cases----------------------------------
	...
	DB_free_result($result);
		...
		echo '<input type="Submit" Name="Casestatusreport" class="md-btn md-btn-primary" Value="View Statuswise Cases"></div>';
...
if(!empty($myrowtransbrieflastcourtdate['prevcourtdate']))
  ...
  <?php 
	...
	echo '<div class="uk-width-medium-1-2" style="padding-bottom:10px">';
	echo '<input type=Submit Name="Partydetailsreport" class="md-btn md-btn-primary" Value="View Party Details Report"></div></div></div></div>';
...
if(!empty($myrowtransbrieflastcourtdate['prevcourtdate']))
	...
	echo '<div class="uk-form-row">';
      ...
      echo '<div class="uk-grid">';
					...
					echo '<label><b>Enter Court Case No</b></label></div>';
                    echo '<div class="uk-width-medium-1-2" style="padding-bottom:10px">';
   ...
   <label style="color:#0000FF">CLICK TO VIEW CASE HISTORY REPORT</label></a>
	...
	echo '<input type=Submit Name="Printlabel" class="md-btn md-btn-primary" Value="View Party Details Report"></div>';
...
if(!empty($myrowtransbrieflastcourtdate['prevcourtdate']))
	...
	echo '<div class="uk-form-row">';
      ...
      echo '<div class="uk-grid">';
        ...
        echo '<input type="hidden" name="ClientIdhidden" id="ClientIdhidden" tabindex="2" >'; 
	echo '<div class="uk-width-medium-1-2" style="padding-bottom:10px">';
	echo '<div class="centre"><input type=Submit Name="partyduesreport" class="md-btn md-btn-primary" Value="View Party Dues"></div></div></div></div>';
		}
...
<?php 
		echo '<input type=Submit Name="Periodwisereport" class="md-btn md-btn-primary" Value="View Report"></div>';
