...
function Header()
{
	...
	$this->Image('adv.png',10,12,12,0,'','', false, $maskImg);
//$this->Image('logo_main.png',150,10,50,0,'','', false, $maskImg);
    // Move to the right
...
function Row($data)
{
	...
	for($i=0;$i<count($data);$i++)
	{
		...
		//Draw the border
		$this->Rect($x,$y,$w,$h);
		if($i==0 OR $i==1 OR $i==3 OR $i==4 OR $i==5 OR $i==6)
		{
...
function CheckPageBreak($h)
{
	...
	$this->Cell(15,7,"ID",1,0,'C',true);
	 $this->Cell(25,7,"Bill No",1,0,'C',true); 
	$this->Cell(55,7,"Bank Name",1,0,'C',true); 
	$this->Cell(25,7,"Phone no",1,0,'C',true); 
	$this->Cell(25,7,"Total Fees",1,0,'C',true); 	
	$this->Cell(25,7,"Amt Received",1,0,'C',true); 
	$this->Cell(25,7,"Balance",1,0,'C',true);
