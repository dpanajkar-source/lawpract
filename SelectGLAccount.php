...
echo '<img id="top" src="images/top.png" alt="">';
    echo '<h1><a>Search for General Ledger Accounts</a></h1>';
...
echo '<table cellpadding=3 colspan=4 align="center">
	<tr>
...
echo '<div class="centre"><input type=submit name="Search" VALUE=' . _('Search Now') . '">
	<input type=submit action=RESET VALUE="' . _('Reset') .'"></div></div>';
...
echo '<img id="top" src="images/top.png" alt="">';
   ...
   echo '<div  id="form_container" >';
	echo '<table cellpadding=2 colspan=7 BORDER=2 align="center">';
