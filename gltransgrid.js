...
{ 
	this.editableGrid = new EditableGrid("gltrans", {
		enableSort: true,
...
DatabaseGrid.prototype.fetchGrid = function()  {
	...
	this.editableGrid.loadJSON("gltransgrid_loaddata.php?db_tablename=gltrans");
};
