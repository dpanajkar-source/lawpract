...
if (isset($_GET['NewJournal']) and $_GET['NewJournal'] == 'Yes' AND isset($_SESSION['JournalDetail'])){
	...
	echo 'reached new journal entry';
...
/*echo '<p><table border=0 width=100%>
	<p class="page_title_text"><img src="'.$rootpath.'/css/'.$theme.'/images/maintenance.gif" title="' . _('Search') . '" alt="">' . ' ' . $title.'<tr><hr></tr>';*/
...
var_dump($_SESSION['JournalDetail']);
	...
	echo "<table border =1 width=85%><tr><td><table width=100%>
			...
			echo '<tr class="EvenTableRows"><td></td>
					<td align=right><b> Total new </b></td>
