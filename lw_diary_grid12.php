...
<div id="page_content">
    ...
    <form>
   		...
   		<div class="uk-width-medium-1-1" style="padding-left:10px; padding-right:10px">
        <div class=" uk-grid-width-2-2 uk-grid-width-large-2-2">
...
<div class="uk-width-medium-1-2" style="padding-bottom:10px" align="right"><h1 class="heading_a"><?php echo date("d-m-Y");   ?></h1> </div>  
...
<div class="uk-width-medium-1-1" padding-top:10px">
      	<input type="text" data-uk-datepicker="{format:'YYYY-MM-DD'}" class="md-input" name="diarydate" id="diarydate" placeholder="Select Diary Date"/></div>
...
<div class="uk-width-medium-1-1 style="padding-bottom:10px"><button type="submit" style="visibility:visible" class='md-btn md-btn-primary' id="LoadRecordsButton">Load Page</button> </div>      
        ...
        <div  class="uk-width-medium-1-1" align="left">
      ...
      Diary Page Entry Date: <input class="md-input" data-uk-datepicker="{format:'YYYY-MM-DD'}" name="Otherdate" id="Otherdate" tabindex="3" value="<?php echo date("Y-m-d"); ?>">
     </div> 
		   
          <input type="hidden"  name="Courtcasenohidden" id="Courtcasenohidden">
  <div class="uk-width-medium-1-3" style="padding-bottom:10px">Party Name <input type="text" class="md-input" name="Partyhidden" id="Partyhidden"></div> 
  <div class="uk-width-medium-1-3" style="padding-bottom:10px">Brief/ File No<input type="text" class="md-input" name="Brief_filehidden" id="Brief_filehidden"></div>
  <div class="uk-width-medium-2-3" style="padding-bottom:10px">
  <?php
 ...
 ?>
    <div class="uk-width-medium-1-3" style="padding-bottom:10px"> <button type="submit" style="visibility:visible" class='md-btn md-btn-primary' id="AddRecordsButton">Add New Row</button></div>
