...
EditableGrid.prototype.serverSide = true;
...
EditableGrid.prototype.isEditable = function(b, a) {
	//here we can change return value to make checkbox in the grid editable or noneditable
    return true
};
...
//below is for the filtering of data in the grid
