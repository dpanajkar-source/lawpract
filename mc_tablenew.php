...
$this->Cell(0,10,'Page '.$this->PageNo().'/{nb}',0,0,'C');
 $this->SetX(150); 
 $this->SetFont('','B','10');
  $this->Cell(0,10,'Generated By Lawpract',0,0,'C'); 
...
function CheckPageBreak($h)
{
	...
	$this->Cell(7,7,"ID",1,0,'C',true); 
	$this->Cell(17,7,"Prev Date",1,0,'C',true); 
	$this->Cell(27,7,"Brief File",1,0,'C',true); 
	$this->Cell(21,7,"Court|judge",1,0,'C',true); 
	$this->Cell(26,7,"Case No",1,0,'C',true); 
	$this->Cell(50,7,"Name Of Parties",1,0,'C',true); 
	$this->Cell(27,7,"Stage",1,0,'C',true); 
