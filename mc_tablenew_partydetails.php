...
function Rowhorizontal($data)
{
	...
	for($i=0;$i<count($data);$i++)
	{
		...
		$y=$this->GetY();
		//Draw the border
		//$this->Rect($x,$y,$w+100,$h);
		
		if($i==4)
		{
		$this->SetFont('','B','10');
		$this->SetFillColor(0,9,95);  
		$this->SetTextColor(255);
		$this->MultiCell($w+100,5,$data[$i],0,$a,1);
		}else
		{		
		//Print the text
		$this->SetFont('Helvetica','',9);
		$this->SetTextColor(0);
		$this->MultiCell($w+200,5,$data[$i],0,$a);
		}
...
{
$this->SetWidths(array(10,20,35,20,40,40,40,50,20));
	...
	$this->Cell(20,7,"Prev Date",1,0,'C',true); 
	$this->Cell(35,7,"Brief File",1,0,'C',true); 
	$this->Cell(20,7,"Court",1,0,'C',true); 
	$this->Cell(40,7,"Case No",1,0,'C',true); 
	$this->Cell(80,7,"Name Of Parties",1,0,'C',true); 
	$this->Cell(50,7,"Stage",1,0,'C',true); 
	$this->Cell(20,7,"Next Date",1,0,'C',true);
	...
	$this->Cell(125,7,"",1,0,'C',False); 
 
	$this->Cell(40,7,"Party",1,0,'C',true); 
	$this->Cell(40,7,"Opposite Party",1,0,'C',true);
	$this->Cell(70,7,"",1,0,'C',False); 
