...
<head>
    ...
    <!-- altair admin -->  <script src="jquery-1.11.1.min.js"></script>
    
    <script src="editablegridcase.js"></script>	
   ...
   <link rel="stylesheet" type="text/css" href="css/ajaxlivesearch.min.css">
     ...
     <script src="transfull.js"></script> 
        ...
        <div id="page_content_inner">
            <div class="md-card">
                <div class="md-card-content">
                   <h1 class="heading_a">FULL DIARY (For Quick Updating- Match previous, current and next dates)</h1>
                   <div class="uk-width-medium-2-2">
        <div class="uk-form-row">
        <div class="uk-grid">
                      <div class="uk-width-medium-1-3" style="padding-bottom:10px"><i class="md-icon material-icons" id="invoice_print">&#xE8ad;</i></div>
                      </div></div></div>
                    <?php include("lw_transactionsfull.php"); ?>
