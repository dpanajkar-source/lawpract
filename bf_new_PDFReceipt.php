<?php
    ...
    require('mc_bf_tablenew_receipt.php');
...
$pdf->SetXY( 10,10 );
$pdf->Image('adv.png',10,12,12,0,'','', false, $maskImg);
$pdf->SetXY( 20,10 );
$pdf->SetFont('Helvetica','B',16);
$pdf->Cell(0,7,$Company['advocatename'],0,0,'C',false);
...
$pdf->Cell(0,10,'Page '.$pdf->PageNo().'/{nb}',0,0,'C');
 ...
 $pdf->Cell(0,10,$Company['advocatename'],0,0,'C',false);
