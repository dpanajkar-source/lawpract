...
<div  style="margin-left:10px; margin-right:10px"; align="justify">
  ...
  <br> </p>
<p><font size="+2"><b>Search Title</b></font>
  <br>
<p>&nbsp;</p>
<p align="center"><img src="images/searchtitle.png" width="700" height="400" /><br>
  <br>
In the search field enter any of the data like caseno, brief no, mobile, client name and select the project for which you want to save details regarding search titles. Write Property name,  and other details then click on add new row. you can see new row added in table shown below in the above image. You will get summary of documents pending on index page</p>
</p></div> 
</div>
 </div> </div> </div> </div>
