...
<html>
	<head>
		...
		<title>To Delete or Archive Cases</title>
    ...
    <div style="float:right; position:static; margin-right:20px; text-decoration:none"><a href="index.php"><img src="home.png" /><br /><label>Home</label></a></div>
		<div id="wrap">
		<label style="font-size:24px; font-weight:bold;">Delete or Archive Cases</label> 
       <div align="right" style="float:right"> <img src="help-over.png" onClick="MM_openbrwindow('doc/manual/Manualarchivecases.php',800,300)"  style="cursor:pointer;" />
     </div>
		...
		<script src="lw_delete.js" ></script>
