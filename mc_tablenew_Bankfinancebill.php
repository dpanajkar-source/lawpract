...
//$this->Image('adv.png',12,12,12,0,'','', false, $maskImg);
    // Move to the right
...
$this->Cell(0,10,'This is a computerized Bill. Does not require signature',0,0,'C');
$this->SetY(-15);
...
function CheckPageBreak($h)
{
	...
	$this->Cell(10,7,"SR No.",1,0,'C',true);
	$this->Cell(30,7,"Application No.",1,0,'C',true);  
	$this->Cell(30,7,"Branch",1,0,'C',true);
	$this->Cell(50,7,"Name of Customer",1,0,'C',true); 
	$this->Cell(40,7,"Loan Amount",1,0,'C',true); 
	$this->Cell(30,7,"Fees Charged",1,0,'C',true);
