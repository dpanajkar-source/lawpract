...
<div class='centre'><input type=submit class='md-btn md-btn-primary' name='Show' VALUE='".'Show Account Transactions'."'></div></form>";
...
echo '<i class="md-icon material-icons" id="invoice_print">&#xE8ad;</i>';
	...
	while ($myrow=DB_fetch_array($TransResult)) {       
		...
		printf("<td>%s</td>
			<td class=number><a href='%s'>Click here</a>%s</td>
			<td>%s</td>
