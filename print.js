...
altair_invoices  = {
    ...
    open_invoice: function() {
        ...
        var show_invoice = function(element) {
            ...
            var invoice_id = parseInt($this.attr('data-invoice-id')),
                context = {
                    invoice_id: {
                        invoice_number:         invoice_id + '/' +  moment().format('YYYY'),
                        invoice_date:           moment().format('DD/MM/YYYY'),
                        invoice_due_date:       moment().add(14,'days').format('DD/MM/YYYY'),
                        invoice_from_company:   'Company',
                        invoice_from_address_1: 'Building',
                        invoice_from_address_2: 'x',
                        invoice_to_company:     '',
                        invoice_to_address_1:   '',
                        invoice_to_address_2:   '',
                        invoice_total_value:    'Rs. 3,751.50',
                        invoice_vat_value:      'Rs. 862.85',
                        invoice_services: [
                            {
                                service_name:           "Law related Fees",
                                service_description:    "",
                               // service_rate:           "Rs. 25.00",
                                //service_hours:          "32",
                                service_vat:            "12.5%",
                                service_total:          "Rs. 984.00"
                            },
                            {
                                service_name:           "Consulting service",
                                service_description:    "Legal services provided",
                                //service_rate:           "Rs. 100.00",
                                //service_hours:          "12.5",
                                service_vat:            "12.5%",
                                service_total:          "Rs. 1,537.50"
                            }
                        ],
    ...
    print_invoice: function() {
        $body.on('click','#invoice_print',function(e) {
            e.preventDefault();
            UIkit.modal.confirm('Do you want to print this window?', function () {
