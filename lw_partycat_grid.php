...
<div id="page_content">
    <div id="page_content_inner">
        ...
        <h3 class="heading_b uk-margin-bottom">Party Category List</h3>
    ...
    <form>
		...
		<div class="uk-width-medium-1-3" style="padding-bottom:10px">
      	<input type="text" class="md-input" name="partycatname" id="partycatname" placeholder="Type Party Category and Enter"/></div>
...
<div class="md-fab-wrapper">
   ...
   <?php include("footersrc.php");      ?>
    ...
    <!--  diff functions -->
    <script src="assets/js/CRUD/partycat.js"></script>
