...
function CheckPageBreak($h)
{
	...
	$this->Cell(25,7,"Court",1,0,'C',true); 
	$this->Cell(35,7,"Case No",1,0,'C',true); 
	$this->Cell(90,7,"Name Of Parties",1,0,'C',true); 

	$this->Cell(30,7,"Mobile",1,0,'C',true); 
	$this->Cell(50,7,"Duration",1,0,'C',true); 
	...
	$this->Cell(110,7,"",1,0,'C',False); 
 
	$this->Cell(45,7,"Party",1,0,'C',true); 
	$this->Cell(45,7,"Opposite Party",1,0,'C',true);
