...
function CheckPageBreak($h)
{
	...
	$this->Cell(25,7,"Brief File",1,0,'C',true); 
	$this->Cell(25,7,"Case No",1,0,'C',true); 
	$this->Cell(20,7,"Court",1,0,'C',true); 
	$this->Cell(50,7,"Name Of Parties",1,0,'C',true); 
	$this->Cell(22,7,"Mobile",1,0,'C',true); 
	$this->Cell(23,7,"Total Fees",1,0,'C',true); 
	$this->Cell(23,7,"Balance",1,0,'C',true);
