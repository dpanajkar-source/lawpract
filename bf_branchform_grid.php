...
<div id="page_content">
    <div id="page_content_inner">
        ...
        <h3 class="heading_b uk-margin-bottom">Bank Branch List</h3>
    ...
    <form>
		...
		<div class="uk-width-medium-1-3" style="padding-bottom:10px">
      	<input type="text" class="md-input" name="branchname" id="branchname" placeholder="Type Branch Name and Enter to search"/></div>
...
<div class="md-fab-wrapper">
  ...
  <?php include("footersrc.php");      ?>
    ...
    <!--  diff functions -->
    <script src="assets/js/CRUD/bf_branchform.js"></script>
