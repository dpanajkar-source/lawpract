...
function CheckPageBreak($h)
{
	...
	$this->Cell(8,7,"ID",1,0,'C',true); 
	$this->Cell(17,7,"Prev Date",1,0,'C',true); 
	$this->Cell(29,7,"Brief/ File",1,0,'C',true); 
	$this->Cell(19,7,"Court",1,0,'C',true); 
	$this->Cell(25,7,"Case No",1,0,'C',true); 
	$this->Cell(50,7,"Name Of Parties",1,0,'C',true); 
	$this->Cell(28,7,"Stage",1,0,'C',true); 
	$this->Cell(19,7,"Next Date",1,0,'C',true);
	...
	$this->Cell(98,7,"",1,0,'C',False); 
 
	$this->Cell(25,7,"Party",1,0,'C',true); 
	$this->Cell(25,7,"Opposite Party",1,0,'C',true);
	$this->Cell(47,7,"",1,0,'C',False); 
