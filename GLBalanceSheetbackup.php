...
//-------------------------------------------------End of first part------------------------------------------------
	...
	//Below starts equities and liabilities on the left hand side
...
// printing of the html balance sheet starts from here
	...
	while ($myrow=DB_fetch_array($AccountsResult)) {
		...
		if ($_POST['Detail']=='Detailed'){
			...
			$ActEnquiryURL = "<a href='$rootpath/lw_GLAccountInquiry_alt.php?" . SID . "Period=" . $_POST['BalancePeriodEnd'] . '&Account=' . $myrow['accountcode'] . "'>" . $myrow['accountcode'] . '<a>';
...
// printing of the html balance sheet starts from here
	...
	<?php	echo '<table class="uk-table">
		...
		<td></td>
																		...
																		//liabilities ithe ahe++++++++++++++++++++++++++++++++
	printf('<table class="uk-table"><tr>
		<td colspan=3><font size=4 color=GREEN>Total %s</font></td> 
   ...
   echo '<table class="uk-table"><tr>
	...
	echo '<div class="uk-width-medium-1-1" style="margin-left:400px">';
		...
		<td></td>
																			...
																			//Assets ithe ahe+++++++++++++++++++++++++++++
	printf('<table class="uk-table"><tr>
		<td colspan=4><font size=4 color=GREEN>Total Assets</font></td> 
		<td class=number><font size=4 color=GREEN>%s</font></td>
