...
<div id="page_content">
    <div id="page_content_inner">
        ...
        <h3 class="heading_b uk-margin-bottom">Case Category List</h3>
    ...
    <form>
		...
		<div class="uk-width-medium-1-3" style="padding-bottom:10px">
      	<input type="text" class="md-input" name="casecatname" id="casecatname" placeholder="Type Case Category and Enter"/></div>
...
<div class="md-fab-wrapper">
  ...
  <?php include("footersrc.php");      ?>
    ...
    <!--  diff functions -->
    <script src="assets/js/CRUD/casecat.js"></script>
