...
<div id="page_content">
    <div id="page_content_inner">
        ...
        <h3 class="heading_b uk-margin-bottom">Case Close/Reopen</h3>
    ...
    <form>
		...
		<div class="uk-width-medium-1-3" style="padding-bottom:10px">
      	<input type="text" class="md-input" name="Courtcaseno" id="Courtcaseno" placeholder="Type Courtcaseno and Enter" onKeyPress="searchRecords();"/></div>
        <div class="uk-width-medium-1-4" align="right" style="padding-right:30px"> <span class="menu_title" style="text-decoration:underline; cursor:pointer" onClick="javascript:MM_openbrwindow('Manualcasehistory.php',600,400);"><i class="material-icons md-color-green-500">&#xE887;</i></span>
        </div>
...
<!--<div class="md-fab-wrapper">
  ...
  <?php include("footersrc.php");      ?>
    ...
    <!--  diff functions -->
    <script src="assets/js/CRUD/casehistory.js"></script>
