		...
		if ($BatchReceiptsTotal!=0){
			...
			$SQL="INSERT INTO gltrans (type,
				...
				VALUES (12,
					...
					" . $BatchReceiptsTotal . ')';
			$DbgMsg = 'The SQL that failed to insert the GL transaction from the bank account debit was';
...
/* Set up a heading for the transaction entry for a GL Receipt */
	...
	echo '<p class="page_title_text"><img src="'.$rootpath.'/css/'.$theme.'/images/transactions.gif" title="' . 'Banked' . '" alt=""> ' . 'General Ledger Receipt Entry' . '</font><table>';
...
if (((isset($_SESSION['CustomerRecord'])
	...
	echo $msg;
	echo '<p class="page_title_text"><img src="'.$rootpath.'/css/'.$theme.'/images/customer.png" title="' . _('Customer') . '" alt="">' . ' ' . 'Select a Customer' . '</b>';
