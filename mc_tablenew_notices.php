...
function CheckPageBreak($h)
{
	...
	$this->Row(array('ID','Notice No','Party','Opposite Party','Notice Date','Send by','Recpt No','Recpt Dt','Claim Dt','Ret. Envelope Date','Received By','Fees','Postage','Other Charges','Remark'));	
