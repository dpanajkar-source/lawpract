...
/* An tax category could be posted when one has been edited and is being updated
  ...
  or deletion of the records*/
	...
	$result = DB_query($sql,$db,$ErrMsg);
echo '<div  id="form_containercasecat" >';
	echo "<table>
		<tr>
		<th>" . _('Available Tax Categories') . "</th>
		</tr>";
...
if (! isset($_GET['delete'])) {
	...
	echo "<tr>
		<td>" . _('Enter New Tax Category') . ':' . "</td>
		<td><input type='Text' name='TaxCategoryName' size=30 maxlength=30 value='" . $_POST['TaxCategoryName'] . "'></td>
		</tr>";
	echo '</table>';

	echo '<div class="centre"><input type=Submit name=submit value=' . _('Enter Information') . ' class="box1"></div>';
